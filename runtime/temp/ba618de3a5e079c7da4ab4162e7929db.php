<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"E:\phpStudy\WWW\WEB/application/wx\view\store\drive.html";i:1515230807;}*/ ?>
<html>
<head>
...
<script type="text/javascript">
    ...
    map.centerAndZoom(new BMap.Point(storeLong,storeLat), 12);

    var driving = new BMap.DrivingRoute(map, {renderOptions: {map: map, panel: "r-result", autoViewport: true}});
    driving.search(disInfo, storeDisInfo);
</script>