<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\phpStudy\WWW\WEB/application/admin\view\room\roomlist.html";i:1514529686;s:61:"E:\phpStudy\WWW\WEB/application/admin\view\public\header.html";i:1514529678;s:61:"E:\phpStudy\WWW\WEB/application/admin\view\public\footer.html";i:1514529677;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="__PATH__admin/room/roomAdd?sid=<?php echo $sid; ?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增房间</button></a>
                            <a href="__PATH__admin/project/projectList?sid=<?php echo $sid; ?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-save"></span> 门店项目</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="am-u-sm-12">
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                <td><?php echo $v['ROOM_CD']; ?></td>
                                <td><a href="#"><?php echo $v['ROOM_NAME']; ?></a></td>
                                <td class="am-hide-sm-only"><?php echo $v['ROOM_TYPE']; ?></td>
                                <td><?php echo $v['STORE_CD']; ?></td>
                                <?php if($v['ROOM_STATE'] == 0): ?>
                                <td>空闲</td>
                                <?php elseif($v['ROOM_STATE'] == 1): ?>
                                <td>预约</td>
                                <?php elseif($v['ROOM_STATE'] == 2): ?>
                                <td>预约锁定</td>
                                <?php elseif($v['ROOM_STATE'] == 3): ?>
                                <td>占用</td>
                                <?php elseif($v['ROOM_STATE'] == 4): ?>
                                <td>全部落种</td>
                                <?php elseif($v['ROOM_STATE'] == 5): ?>
                                <td>待清台</td>
                                <?php endif; if($v['ROOM_SIGN'] == 0): ?>
                                <td>非客房</td>
                                <?php else: ?>
                                <td>客房</td>
                                <?php endif; if($v['AVAILABLE_FLG'] == 1): ?>
                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="<?php echo url('admin/room/roomEdit',['room_cd'=>$v['ROOM_CD'],'sid'=>$sid]); ?>"  class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                            <a href="#"  class="am-btn am-btn-default am-btn-xs am-text-secondary delete-list-btn" data-id="<?php echo $v['ROOM_CD']; ?>" data-sid="<?php echo $sid; ?>"><span class="am-icon-trash-o"></span> 设置</a>
                                            <a href="#"  class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only delete-room-btn" data-id="<?php echo $v['ROOM_CD']; ?>" data-sid="<?php echo $sid; ?>"><span class="am-icon-trash-o"></span> 删除</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
