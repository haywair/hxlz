<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\phpStudy\WWW\WEB/application/admin\view\user\userlist.html";i:1514529693;s:61:"E:\phpStudy\WWW\WEB/application/admin\view\public\header.html";i:1514529678;s:61:"E:\phpStudy\WWW\WEB/application/admin\view\public\footer.html";i:1514529677;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
        ...
        <div class="card-box">
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-3">
                    <form action="<?php echo url('admin/user/userList'); ?>" method="post">
                    <div class="am-input-group am-input-group-sm">
                        <input type="text" class="am-form-field" name="NICK_NAME" placeholder="请输入用户名"  value="<?php if(!(empty($nick_name) || (($nick_name instanceof \think\Collection || $nick_name instanceof \think\Paginator ) && $nick_name->isEmpty()))): ?><?php echo $nick_name; endif; ?>">
                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <th class="table-date am-hide-sm-only">最后登录</th>
                            ...
                            <tr>
                                ...
                                <td><a href="#"><?php echo $v['NICK_NAME']; ?></a></td>
                                <td><img  style="height: 30px;" src="<?php echo $v['PHOTO_HEAD']; ?>"></td>
                                <?php if($v['SEX'] == 1): ?>
                                <td>男</td>
                                <?php else: ?>
                                <td>女</td>
                                <?php endif; ?>
                                <td class="am-hide-sm-only"><?php echo $v['TEL_NO']; ?></td>
                                <td class="am-hide-sm-only"><?php echo $v['UPDATE_DATE']; ?></td>
                                    ...
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                           <!-- <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</button>-->
                                            <a href="#" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only delete-list-btn" data-id="<?php echo $v['USER_ID']; ?>"><span class="am-icon-trash-o"></span>设置</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">状态设置</div>
        ...
        $('.delete-list-btn').click(function() {
            ...
            $('#my-confirm').modal({
                ...
                onConfirm: function(options) {
                    window.location.href = "__PATH__admin/user/userDel/user_id/"+user_id;
                },
