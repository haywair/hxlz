<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\phpStudy\WWW\WEB/application/admin\view\room\roomtimelist.html";i:1514529689;s:61:"E:\phpStudy\WWW\WEB/application/admin\view\public\header.html";i:1514529678;s:61:"E:\phpStudy\WWW\WEB/application/admin\view\public\footer.html";i:1514529677;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="__PATH__admin/room/roomTimeAdd"><button type="button"  class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
                        </div>
                    </div>
                </div>

                <div class="am-u-sm-12 am-u-md-3">
                    <form action="<?php echo url('admin/room/roomTimeList'); ?>" method="post">
                    <div class="am-input-group am-input-group-sm">
                        <input type="text" class="am-form-field" name="STORE_NAME" value="<?php if(!(empty($store_name) || (($store_name instanceof \think\Collection || $store_name instanceof \think\Paginator ) && $store_name->isEmpty()))): ?><?php echo $store_name; endif; ?>" placeholder="请输入店铺名称">
                ...
                <div class="am-u-sm-12">
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                <td><?php echo $v['TIME_CD']; ?></td>
                                <td><a href="#"><?php echo $v['ORDER_START_DATE_TIME']; ?></a></td>
                                <td><a href="#"><?php echo $v['ORDER_END_DATE_TIME']; ?></a></td>
                                <td><a href="#"><?php echo $v['PRICE']; ?></a></td>
                                <td><a href="#"><?php echo $v['STORE_NAME']; ?></a></td>
                                <?php if($v['AVAILABLE_FLG']): ?>
                                <td><a href="javascript:void(0);"  class="am-btn am-btn-default am-btn-xs am-text-secondary"> 可用</a></td>
                                <?php else: ?>
                                <td><a href="javascript:void(0);"  class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"> 不可用</a></td>
                                <?php endif; ?>
                                <td></td>
                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="<?php echo url('admin/room/roomTimeEdit',['time_cd'=>$v['TIME_CD']]); ?>"  class="am-btn am-btn-default am-btn-xs am-text-secondary">
                                                <span class="am-icon-pencil-square-o"></span> 编辑
                                            </a>
                                            <a href="javascript:void(0);" data-id="<?php echo $v['TIME_CD']; ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only delete-list-btn"><span class="am-icon-trash-o"></span> 设置</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">更改时段可用状态</div>
        ...
        $('.delete-list-btn').click(function() {
            ...
            $('#my-confirm').modal({
                ...
                onConfirm: function(options) {
                    window.location.href = "__PATH__admin/room/timeSetFlg/time_cd/"+time_cd;
                },
